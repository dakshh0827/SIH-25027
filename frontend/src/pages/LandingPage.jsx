  ...
  events: [
    {
      ...
      date: "2023-09-15",
      details:
        "Ashwagandha (Withania somnifera) harvested by farmer collective in Jaipur, Rajasthan.",
    ...
    },
    {
      ...
      date: "2023-09-25",
      details:
        "Tested for heavy metals and microbial limits. Report #NABL-TC-1234.",
      location: "28.7041° N, 77.1025° E",
    ...
    },
    {
      ...
      date: "2023-09-30",
      details:
        "Encapsulated and packaged with unique QR code for consumer traceability.",
      location: "28.7041° N, 77.1025° E",
      actor: "VedaHerbs Ayurvedic Pvt. Ltd.",
      icon: Waves,
    },
  ...
  const handleSearch = () => {
    ...
    setTimeout(() => {
      ...
      if (searchTerm.toUpperCase().trim() === mockProvenanceData.batchId) {
        ...
        toast.success(
          `✅ Found provenance record for ${mockProvenanceData.batchId}!`,
          {
            duration: 4000,
            position: "top-right",
          }
        ...
        setProvenanceData(null);
        toast.error(
          `❌ No record found for "${searchTerm}". Try: ${mockProvenanceData.batchId}`,
          {
            duration: 4000,
            position: "top-right",
          }
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto space-y-8" ref={heroRef}>
            ...
            <div className="hero-animate space-y-6">
              <p className="text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto leading-relaxed font-light">
                Scan a QR code or enter a batch ID to view the full journey of
                your{" "}
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          {!loading && !provenanceData && searchTerm && (
            <div className="text-center text-red-400 mt-8 py-12">
              <p className="text-lg">
                No matching record found for that batch ID.
              </p>
        ...
        <div
          className="max-w-7xl mx-auto px-6 py-20 animated-section"
          ref={mostViewedRef}
        >
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              See what other customers are tracing to ensure quality and
              authenticity
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 animated-section">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg max-w-3xl mx-auto">
              Explore verified traceability reports from our network of farmers,
              manufacturers, and laboratories. Each QR code provides complete
              supply chain transparency.
            </p>
          </div>

          {/* Public QR Grid Component */}
          <PublicQRGrid />
        </div>
        ...
        <div className="max-w-4xl mx-auto px-6 py-20 text-center animated-section">
          <div className="bg-slate-900/40 backdrop-blur-md border border-transparent p-12 transition-all duration-300 hover:bg-slate-800 hover:border-emerald-400 active:scale-[0.98]">
            ...
            <p className="text-slate-300 text-lg mb-8 leading-relaxed">
              Join the future of supply chain transparency and help build trust
